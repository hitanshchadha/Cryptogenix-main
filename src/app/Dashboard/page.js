...
function UserDashboard() {
    ...
    <h1 className='text-white mt-12 text-5xl flex justify-between font-mono' >Welcome  {user?.name}👋</h1>
    <div className="text-white  font-mono flex">
        <div className="w-2/4 h-[20vh] rounded-3xl mt-6 text-2xl bg-white p-4 text-black flex flex-col">
          <span className=" font-bold text-4xl">Connected Email:</span> 
...
//   return (
//     <div>
//       <h1 className="text-white">Welcome, {user?.name || "User"}!</h1>
//     </div>
//   );
// };
