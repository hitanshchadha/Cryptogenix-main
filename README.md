...
* NextAuth.js: Integrated for authentication, enabling users to log in securely via Google OAuth.
* Prisma: Utilized as an ORM to interact with the PostgreSQL database efficiently, ensuring structured and scalable data management.
* PostgreSQL: The primary database used to store user data, wallets, transactions, and authentication details.
### Deployment & Hosting
* Vercel: Used for hosting the frontend and backend, ensuring seamless deployment and scalability.
# Getting Started
## Prerequisites
...
## Working Demos:
* [Demo Video( old )](https://drive.google.com/file/d/1H0jSl8HiTNrnVrL-yXDl_OKr8malZ_0K/view?usp=sharing)
